...
<html>
    ...
    <body>
        ...
        <div class="container" style="margin-top:100px;margin-bottom:250px;">
            ...
            <div class="page-header">
                ...
                <h1><% String err = (String) session.getAttribute("err");
                    out.print("<h1>" + err + "</h1>");
    ...
    //            out.print("<h1>"+err+"</h1>");
                String username = (String) session.getAttribute("userName");
                if (username != null) //                out.print("<a href='loginsuccess.jsp'>back to index page</a>");
                {
                    out.print("<p>You will be redirect to home page in 3 seconds...</p>"
                            + "<meta http-equiv=\"Refresh\" content=\"3;url=loginsuccess.jsp\">");
                } else //                out.print("<a href='index.html'>back to index page</a>");
                {
                    out.print("<p>You will be redirect to home page in 3 seconds...</p>"
                            + "<meta http-equiv=\"Refresh\" content=\"3;url=loginsuccess.jsp\">");
                }
